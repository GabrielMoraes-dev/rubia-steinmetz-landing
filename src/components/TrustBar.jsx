      ...
      <ul className="mx-auto grid max-w-6xl grid-cols-2 gap-3 px-5 py-10 sm:gap-4 sm:px-8 lg:grid-cols-4 lg:py-10">
        {items.map((item, i) => (
          <Reveal as="li" key={item} delay={i * 80}>
            <div className="flex h-full flex-col items-center gap-3 rounded-2xl border border-white/10 bg-white/5 p-4 text-center shadow-sm transition-all duration-300 ease-premium sm:p-5 lg:flex-row lg:items-start lg:text-left lg:hover:border-gold/30 lg:hover:bg-white/10">
